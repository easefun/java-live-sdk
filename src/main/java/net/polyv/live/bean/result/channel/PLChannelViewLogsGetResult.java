...
public class PLChannelViewLogsGetResult extends PLBaseResult {
    ...
    public List<ChannelViewLog> getChannelViewLogs() {
        return channelViewLogs;
    }

    public void setChannelViewLogs(List<ChannelViewLog> channelViewLogs) {
        this.channelViewLogs = channelViewLogs;
    }
    ...
    public String toString() {
        return "PLChannelViewLogsResult{" +
                "code=" + code +
                ", pageNumber=" + pageNumber +
                ", status='" + status + '\'' +
                ", totalItems=" + totalItems +
                ", message='" + message + '\'' +
                ", channelViewLogs=" + channelViewLogs +
                ", endRow=" + endRow +
                ", startRow=" + startRow +
                ", firstPage=" + firstPage +
                ", lastPage=" + lastPage +
